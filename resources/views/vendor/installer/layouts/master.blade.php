...
<head>
    ...
    <title>@if (trim($__env->yieldContent('template_title')))@yield('template_title') | @endif {{ __('HUBKOLO SaaS') }}</title>
...
<div class="master">
    ...
    <div class="box">
        ...
        <ul class="step">
            ...
            <li class="step__item {{ isActive('LaravelInstaller::default_module') }} {{ isActive('LaravelInstaller::final')}}">
