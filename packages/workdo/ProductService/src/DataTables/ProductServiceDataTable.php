    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        $dataTable = (new EloquentDataTable($query))
            ...
            ->editColumn('quantity', function (ProductService $productService) {
                if ($productService->type == 'product' || $productService->type == 'parts' || $productService->type == 'consignment' || $productService->type == 'rent' || $productService->type == 'music institute' || $productService->type == 'optical eyecare') {
