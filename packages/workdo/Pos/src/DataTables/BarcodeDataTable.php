...
class BarcodeDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        return $dataTable->rawColumns(['image']);
    }
    ...
    {
       $productServices = $model->where('created_by', creatorId())->where('workspace_id',getActiveWorkSpace());
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('name')->title(__('Product')),
            Column::make('sku')->title(__('SKU')),
            Column::make('image')->title(__('Barcode'))
                ->exportable(false)
                ->printable(false)
                ->width(60)
